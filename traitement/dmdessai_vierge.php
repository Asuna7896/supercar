    ...
    <center>
        ...
        <div class="col-md-7 col-lg-6 mb-2">
            <div class="form-group mb-0">
                <a href="../car.php" class="btn btn-primary btn-block" type="submit" style="height: 50px;">
                    Appuyez ici pour choisir une
                    voiture</a>
            </div>
            <br>
            <form action="traitement1.php" method="post">
                ...
                <div class="bg-secondary p-5">
                    ...
                    <div class="form-group">
                        ...
                        echo '<input type="text" class="form-control p-4"  name="marque">';
                        echo '</div>';

                        echo '<p style="color:#898a94">Nom de la voiture</p>';
                        echo '<div class="form-group">';
                        echo '<input type="text" class="form-control p-4"  required name="v_nom">';
                        echo '</div>';

                        echo '<p style="color:#898a94">Type de la voiture</p>';
                        echo '<div class="form-group">';
                        echo '<input type="text" class="form-control p-4" required name="type">';
                        echo '</div>';

                        echo '<p style="color:#898a94">Transmission</p>';
                        echo '<div class="form-group">';
                        echo '<input type="text" class="form-control p-4"  required name="transmission">';
                        echo '</div>';
                        ?>
                    ...
                    <div class="form-group">
                        ...
                        <select name="civilite" class="custom-select px-4" style="height: 50px;">
